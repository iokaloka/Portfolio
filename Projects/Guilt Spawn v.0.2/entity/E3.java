...
public class E3 extends Enemy {
    ...
    public E3(TileMap tm) {
        ...
        health = maxHealth = 3;
        damage = 1;
        s = new Sprite("/sprites/enemies/e3.png");
        ani = new Animation();
        right = true;
        facingRight = true;
        //load sprites here;
    ...
    public Rectangle getRectangle(){
        return new Rectangle((int) getX() - (cwidth / 2), (int) getY() - 45, cwidth, cheight);
    }
    ...
    public void tick() {
        ...
        if (timer >= 30) {
            ...
            ani.setSpeed(tileMap.getR().nextInt(20));
            maxSpeed = tileMap.getR().nextInt(8) + 3;
            moveSpeed = tileMap.getR().nextInt(3) + 0.5;
        }
    }
    ...
    public void render(Graphics g) {
        ...
        if (facingRight) {
            ...
            g.drawImage(this.ani.getImage(), (int) getX() - (cwidth / 2), (int) getY() - 45, cwidth, cheight, null);
        } else {
            g2.draw(getRectangle());
            g.drawImage(this.ani.getImage(), (int) getX() + (cwidth / 2), (int) getY() - 45, -cwidth, cheight, null);
        }
